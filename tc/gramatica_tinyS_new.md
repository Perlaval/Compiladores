...
```
1. Program -> ListaDefiniciones
2. Start -> start BloqueMetodo
3. ListaDefiniciones -> Class ListaDefiniciones | Impl ListaDefiniciones | Start
4. Class -> class idClass HerenciaOpt
5. HerenciaOpt -> { ListaAtributos | Herencia { ListaAtributos 
6. ListaAtributos -> } | Atributo ListaAtributos
7. Impl -> impl idClass ListaMiembrosAux
8.ListaMiembrosAux -> { ListaMiembros
9. ListaMiembros -> } | Miembro ListaMiembros
9. Herencia -> Tipo
10. Miembro -> Metodo | Constructor
11. Metodo -> FormaMetodo fn TipoMetodo idMetAt ArgumentosFormales BloqueMetodo
11. Metodo -> fn TipoMetodo idMetAt ArgumentosFormales BloqueMetodo
11. Metodo -> FormaMetodo fn idMetAt ArgumentosFormales BloqueMetodo
11. Metodo -> fn idMetAt ArgumentosFormales BloqueMetodo
14. ArgumentosFormales -> ( ListaArgumentosFormales
14. ListaArgumentosFormalesOpt -> ) | ListaArgumentosFormales ListaArgumentosFormalesOpt 
15. Constructor -> . ArgumentosFormales BloqueMetodo
16. Atributo -> Visibilidad Tipo ListaDeclaracionVar
16. Atributo -> Tipo ListaDeclaracionVar
18. Tipo -> TipoPrimitivo | TipoReferencia | TipoArreglo
19. ListaDeclaracionVar -> idMetAt ListaDeclaracionesVarRec
20. ListaDeclaracionVarRec -> , ListaDeclaracionVar | ;
21. BloqueMetodo -> { BloqueMetodoAux
21. BloqueMetodoAux -> ListaDeclaracionVarLocal | ListaSentencia
22. ListaDeclaracionVarLocal -> DeclaracionVarLocal ListaDeclaracionVarLocal | ListaSentencia
23. ListaSentencia -> Sentencia ListaSentencia | }
24. Visibilidad -> pub
25. FormaMetodo -> st
...
32. ListaArgumentosFormalesRec -> , ArgumentoFormal ListaArgumentosFormalesRec |  )
...
46. ListaEncadenadoSimple -> = | EncadenadoSimpple ListaEncadenadoSimple
...
Prim(TipoMetodo)= {str, bool, int, idClass, Array, void}
